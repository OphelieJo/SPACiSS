...
Ped::Tagent::Tagent()
{
  ...
  //values from Experimental characterization of collision avoidance in pedestrian dynamics
...
void Ped::Tagent::assignScene(Ped::Tscene* sceneIn)
{
  scene = sceneIn;
}
...
/// \param   f The factor
void Ped::Tagent::setForceFactorDesired(double f)
{
  forceFactorDesired = f;
}

/// Sets the factor by which the social force is multiplied. Values between 0
/// and about 10 do make sense.
/// \param   f The factor
void Ped::Tagent::setForceFactorSocial(double f)
{
  forceFactorSocial = f;
}
...
/// and about 10 do make sense.
/// \param   f The factor
void Ped::Tagent::setForceFactorObstacle(double f)
{
...
void Ped::Tagent::move(double stepSizeIn)
{
  ...
  a = forceFactorDesired * desiredforce + forceFactorSocial * socialforce + forceFactorObstacle * obstacleforce +
      myforce;
